...
Para isso serão utilizados inicialmente dados históricos diários de ativos da B3, como fiis, ações, índices e ETFs, para treinar e testar o modelo, coletando usando a API do metatrader como fonte primária dos dados, extraindo preços de abertura, fechamento, maxima, minima e volume. Serão também calculados indicadores técnicos para enriquecer a base de dados: RSI (Relative Strength Index) de 9 períodos, MACD (Moving Average Convergence Divergence), Bollinger Bands, entre outros.
