...
# Metodologia
 ...
 Esse pesquisa usará uma abordagem quantitativa, para desenvolver e validar um modelo de machine learning para seleção dinamica de ativos em estratégia de pair trading, utilizando dados históricos do mercado financeiro brasileiro e será dividido em 3 etapas principais: seleção de pares, modelagem e testes.
 A etapa de seleção de pares se iniciará com a coleta de dados históricos diários de ativos da B3 por meio de fontes confiáveis, como a api do Metatrader, com um período mínimo de 5 anos. Nele buscarmos informações de abertura, fechamento, maxima e mínima de ações e fundos listados em bolsa, junto com indicadores técnicos, como índice de força relativa, médias móveis e volatilidade histórica, entre outros. O pré-processamento filtrará para garantir que os ativos possuam liquidez suficiente para operações de pair trading. 
Feature en

Para isso serão utilizados inicialmente dados históricos diários de ativos da B3, como fiis, ações, índices e ETFs, junto com indicadores técnicos, como correlação, volatilidade, índice de força relativa, entre outros. Com isso aplicaremos um algoritmo de clustering aos ativos, para formar grupos semelhantes e selecionar os pares utilizados no estudo. Implementaremos uma estratégia de trading simples, baseada em reinforcment learning e buscaremos definir regras claras de entrada e saída baseadas no spread do par, para que possamos avaliar o desempenho do modelo.
